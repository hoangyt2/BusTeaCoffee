...
//    public WorkPlan findByDateAndShiftCode(Date shiftDate, int ShiftCode){
//
//    }
    ...
    public void scheduleCreateWorkPlanForNextWeek() {
        Calendar firstDayOfNextWeek = Utils.getFirstDayOfNextWeek();
        Calendar lastDayOfNextWeek = Utils.getLastDayOfNextWeek();
        List<WorkPlan> abc = workPlanRepository.findAllByShiftDateBetween(firstDayOfNextWeek.getTime(),lastDayOfNextWeek.getTime());
