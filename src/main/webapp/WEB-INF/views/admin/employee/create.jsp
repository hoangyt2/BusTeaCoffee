...
<div class="content flex-column-fluid" id="kt_content">
    ...
    <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
        ...
        <div class="card-body p-9">
            <form:form action="/admin/employee" method="post" enctype="multipart/form-data" modelAttribute="employeeAddVO">
                ...
                <div class="form-floating my-5">
                    <input type="text" class="form-control" id="employeeName" name="name" placeholder="VIP" required/>
                    <label for="employeeName">Tên nhân viên mới</label>
                </div>
                <div class="form-floating my-5">
                    <input type="text" class="form-control" id="employeeAddress" name="address" placeholder="VIP" required/>
                    <label for="employeeAddress">Địa chỉ</label>
                </div>
                <div class="form-floating my-5">
                    <input type="text" class="form-control" id="employeeEmail" name="email" placeholder="VIP" required/>
                    <label for="employeeEmail">Email</label>
                </div>
                <div class="form-floating my-5">
                    <input type="text" class="form-control" id="employeePhone" name="phoneNumber" placeholder="VIP" required/>
                    <label for="employeePhone">Phone</label>
                </div>
                <div class="form-floating my-5">
                    <input type="date" class="form-control" id="employeeBirthday" name="birthDay" placeholder="VIP" required/>
...
<%--                        <option selected>Bấm để chọn</option>--%>
                ...
                <br>
                <div class="form-floating">
                    <select class="form-select h-100" id="employeeStatus" name="maritalStatus"
                            aria-label="Floating label select example">
<%--                        <option selected>Bấm để chọn</option>--%>
                ...
                <div class="form-floating my-5">
                    <input value="0" type="number" class="form-control" id="employeeSalary" name="coefficientsSalary"
                           placeholder="VIP"/>
