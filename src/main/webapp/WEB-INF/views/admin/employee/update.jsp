...
<div class="content flex-column-fluid" id="kt_content">
    ...
    <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
        ...
        <!--begin::Card body-->
        <div class="row mt-10">
            <form:form action="/admin/employee/update/${employee.id}" method="post" enctype="multipart/form-data" modelAttribute="employee">
                <div class="col">
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table align-middle table-row-dashed gy-5" id="kt_table_users_login_session">
                                    ...
                                    <tr>
                                        <td>Tên nhân viên</td>
                                        <td>
                                            <input type="text"  class="form-control" id="employeeName" name="name" placeholder="VIP" value="${employee.name}" required/>
                                    ...
                                    <tr>
                                        <td>Địa Chỉ</td>
                                        <td><input type="text" class="form-control" id="employeeAddress" name="address" value="${employee.address}" required/>

                                    </tr>
                                    <tr>
                                        <td>Email</td>
                                        <td><input type="text" class="form-control" id="employeeEmail" name="email" value="${employee.email}" required/></td>
                                    ...
                                    <tr>
                                        <td>Số điện thoại</td>
                                        <td><input type="text" class="form-control" id="employeePhone" name="phoneNumber" value="${employee.phoneNumber}" required/></td>
                                    </tr>
                                    <tr>
                                        <td>Hệ số lương</td>
