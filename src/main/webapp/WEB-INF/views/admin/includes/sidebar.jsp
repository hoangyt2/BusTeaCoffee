...
/>
			...
			<div data-kt-menu-trigger="click" class="menu-item  menu-accordion">
				...
				<div class="menu-sub menu-sub-accordion">
					...
					<div class="menu-item active">
						<!--begin:Menu link-->
						<a class="menu-link" href="${pageContext.request.contextPath}/admin/importgoods">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
							<span class="menu-title">Danh sách nhập hàng</span>
						</a>
						<!--end:Menu link-->
					</div>
					<!--end:Menu item-->
...
/>
                                                ...
                                                <span class="menu-title">Quản lí giảm giá</span>
                                                <span class="menu-arrow"></span>
                                            </span>
				<!--end:Menu link-->
				<!--begin:Menu sub-->
				<div class="menu-sub menu-sub-accordion">
					...
					<div class="menu-item">
						...
						>
							...
							<span class="menu-title">Xem danh sách đợt giảm giá</span>
						</a>
						<!--end:Menu link-->
					</div>
					<!--end:Menu item-->
					...
					<div class="menu-item">
						...
						>
							...
							<span class="menu-title">Thêm mới đợt giảm giá</span>
						</a>
						<!--end:Menu link-->
					</div>
					<!--end:Menu item-->
...
<%--			</div>--%>
                                                ...
                                                <span class="menu-icon">
                                                    ...
                                                    <span class="svg-icon svg-icon-3">
														...
														>
                                                            ...
                                                            <path d="M20.1 6.65L12.3 2.15C12 1.95 11.6 1.95 11.3 2.15L3.5 6.65C3.2 6.85 3 7.15 3 7.45V16.45C3 16.75 3.2 17.15 3.5 17.25L11.3 21.75C11.5 21.85 11.6 21.85 11.8 21.85C12 21.85 12.1 21.85 12.3 21.75L20.1 17.25C20.4 17.05 20.6 16.75 20.6 16.45V7.45C20.6 7.15 20.4 6.75 20.1 6.65ZM5 15.85V7.95L11.8 4.05L18.6 7.95L11.8 11.95V19.85L5 15.85Z" fill="currentColor"/>urrentColor"
                                                            />
                                                        </svg>
                                                    </span>
													<!--end::Svg Icon-->
			...
			<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
				...
				<span class="menu-link">
                                                ...
                                                <span class="menu-title">Quản lí kho</span>
                                                <span class="menu-arrow"></span>
                                            </span>
				<!--end:Menu link-->
				<!--begin:Menu sub-->
				<div class="menu-sub menu-sub-accordion">
					...
					<div class="menu-item">
						...
						>
							...
							<span class="menu-title">Danh Sách Nguyên Liệu</span>
						</a>
						<!--end:Menu link-->
					</div>
					<!--end:Menu item-->
					...
					<div class="menu-item">
						...
						>
							...
							<span class="menu-title">Thêm nguyên liệu</span>
						</a>
						<!--end:Menu link-->
					</div>
					<!--end:Menu item-->
