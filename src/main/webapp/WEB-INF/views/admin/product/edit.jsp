...
<div class="content flex-column-fluid" id="kt_content">
    ...
    <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
        ...
        <div class="card-body p-9">
            <form:form action="/admin/product/edit/${product.id}" method="post" enctype="multipart/form-data" modelAttribute="productUpdateVO">
...
<%--                    </div>--%>
                    <div class="form-floating my-5">
                        <input type="describe" class="form-control" id="describe" name="describe" placeholder="0" value="${product.describe}" required/>
