        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 align-right">
                ...
                <div class="kf-h-group">
                    ...
                    <em>Địa chỉ :</em> BusTea Coffe, H34/08 K01 Mẹ Suốt, Liên Chiểu, TP Đà Nẵng
                </div>
            ...
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 align-center">
                ...
                <div class="kf-main-menu">
                    <ul>
                        ...
                        <li><a href="/login"><button>Go To Login</button> </a></li>
                    </ul>
                </div>
        ...
        <div class="kf-topline">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    ...
                    <div class="kf-h-group">
                        <i class="fas fa-map-marker-alt"></i>
                        <em>Location :</em> BusTea Coffe, H34/08 K01 Mẹ Suốt, Liên Chiểu, Thành phố Đà Nẵng
                    </div>
